...
val eggCartonImmutable: List<Egg?> =
  listOf(
    null, // No Egg to validate
    Egg(1, Yolk(GOOD, GOLD)), // About to hatch
    Egg(8, Yolk(BAD, ORANGE)), // Yolk is bad
...
val expectedImperativeValidationResults: Map<Int, ValidationFailure> =
  mapOf(
...
val expectedDeclarativeValidationResults: List<Either<ValidationFailure, Egg>> =
  listOf(
