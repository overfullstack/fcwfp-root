...
/**
 * Problems: ∙ No rules, any function can call any other function ∙ Mutation . Non-sharable
 * validations ∙ Unit-Testability ∙ Validation Jenga ∙ Complexity
 */
fun validate1(
...
fun validateEggCartonImperatively2(
  eggCarton: MutableList<Egg?>
): MutableMap<Int, ValidationFailure> {
  ...
  while (iterator.hasNext()) {
    ...
    // Global state is dangerous. badEggFailureBucketMap and iterator being passed to each and every
    // function, difficult to keep track of how they are being mutated during debugging.
