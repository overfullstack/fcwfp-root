...
import static ga.overfullstack.common.Common.DELIMITER;
...
class StreamConcat {
  ...
  UnaryOperator<String> extractLastName =
  ...
  private String concatLastNamesStage1(List<String> team) {
    return team.stream().map(extractLastName).collect(Collectors.joining(DELIMITER));
  }
