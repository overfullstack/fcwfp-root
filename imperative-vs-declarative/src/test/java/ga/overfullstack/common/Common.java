...
public final class Common {
  public static final List<String> TEAM =
      Arrays.asList(
          "Venky Viswanathan",
          "Satya", // One word name
          "Anshul Rawat",
          ...
          "Ravi Shankar",
          "Manoj Kumar  Pendhyala", // Only One word in a 3 word name separated by more than one
          // space
          "", // Empty - We are hiring! ;)
          "Manikanta Yakkala",
  ...
  public static final String EXPECTED_RESULT =
      "Viswanathan 🤝 Satya 🤝 Rawat 🤝 Tripathi 🤝 Yadala 🤝 Akshintala 🤝 Shankar 🤝 Pendhyala 🤝 Yakkala 🤝 Ahmed 🤝 Sharma 🤝 Tammana 🤝 Vemula 🤝 Kapoor";
}
