...
public class RailwayValidation1 {
  ...
  public static final UnaryOperator<
          Either<ga.overfullstack.app.domain.validation.ValidationFailure, ImmutableEgg>>
      validate1Simple =
          validatedEgg ->
              validatedEgg.filterOrElse(
                  Rules::simpleOperation1,
                  ignore ->
                      ga.overfullstack.app.domain.validation.ValidationFailures
                          .NO_EGG_TO_VALIDATE_1);
                  ...
                  .flatMap(
                      tryResult ->
                          tryResult
                              ...
                              .mapLeft(
                                  cause ->
                                      ga.overfullstack.app.domain.validation.ValidationFailure
                                          .withErrorMessage(
                                              cause.getMessage()))) // Trick in the Monad
  ...
  public static final UnaryOperator<
          Either<ga.overfullstack.app.domain.validation.ValidationFailure, Yolk>>
      validateChild31 =
          validatedYolk ->
              validatedYolk
