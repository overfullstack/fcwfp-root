...
public final class RailwayValidation {
  ...
  public static Either<ValidationFailure, ?> validate1(
      Either<ValidationFailure, ImmutableEgg> validatedEgg) {
    return validatedEgg
        .filter(Rules::simpleOperation1)
        .getOrElse(() -> Either.left(ValidationFailures.NO_EGG_TO_VALIDATE_1));
  }

  public static Either<ValidationFailure, ?> validate2(
      Either<ValidationFailure, ImmutableEgg> validatedEgg) {
    return validatedEgg
  ...
  private static Either<ValidationFailure, ?> validateParent3(
      Either<ValidationFailure, ImmutableEgg> validatedEgg) {
    return validatedEgg
  ...
  public static Either<ValidationFailure, ?> validateChild31(
      Either<ValidationFailure, Yolk> validatedYolk) {
  ...
  public static Either<ValidationFailure, ?> validateChild32(
      Either<ValidationFailure, Yolk> validatedYolk) {
    return validatedYolk
        .map(yolk -> liftTry(Rules::throwableNestedOperation3).apply(yolk))
        .flatMap(
  ...
  private static Either<ValidationFailure, ?> validateParent41(
      Either<ValidationFailure, ImmutableEgg> validatedEgg) {
    return validatedEgg
        .map(egg -> liftTry(Rules::throwableOperation3).apply(egg))
        .flatMap(
  ...
  private static Either<ValidationFailure, ?> validateParent42(
      Either<ValidationFailure, ImmutableEgg> validatedEgg) {
    return validatedEgg
        .map(egg -> liftTry(Rules::throwableOperation3).apply(egg))
        .flatMap(
  ...
  public static Either<ValidationFailure, ?> validateChild4(
      Either<ValidationFailure, Yolk> validatedYolk) {
    return validatedYolk
        .map(yolk -> liftTry(Rules::throwableNestedOperation3).apply(yolk))
        .flatMap(
